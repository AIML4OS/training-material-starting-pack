...
- If you use `R`, we recommend that you use `renv`, cf its [official documentation](https://rstudio.github.io/renv/articles/renv.html);
- If you use `Python`, we recommend that you use `uv`, cf its [official documentation](https://docs.astral.sh/uv/)
