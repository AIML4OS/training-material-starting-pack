...
- Define all aspects of the training environment using the usual interface. Here are the elements you will probably want to configure:
  ...
  - `GIT`: In the "Repository" field, paste the URL of the Github repository containing the resources. __Do not forget to remove your Git credentials (name, email and token).__
