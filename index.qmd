...
Your scripts may require some data to run (for instance: training data for an algorithm). To download data automatically, you just have to adapt the `download_data.sh` file (in the `sspcloud` folder) so that your data is downloaded to your folder of choice.
