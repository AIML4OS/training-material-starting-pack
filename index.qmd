...
- When you start working on your project with a new service, you should run `renv::restore()`. This command will reinstall all the packages listed in the `renv.lock` file. __You do not need to do it if you use the `R` template__ because the initialization script does it for you.
