...
After running these commands, go to your repository on Github, click on __Settings__, then on __Pages__. Under "Build and deployment", under "Source", select __Deploy from a branch__. Under "Build and deployment", use the branch dropdown menu and select the `main` branch. From then on, your website should be deployed anytime you push to the `main` branch.
