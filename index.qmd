...
The script `init-trainees.sh` provided in the `sspcloud` folder of the _template_ helps you to configure the environment for trainees on the SSPCloud. This script does two things: install the environment needed to run the notebook (using `renv`) and download the Quarto file you want to provide trainees with. 
