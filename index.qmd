...
- Develop the content;
- Add the qmd file to the list in the `render` argument of the `_quarto.yml` file, so that Quarto compiles it.

The `notebooks` subfolder of the `Python` template already contains an example.
