...
:::: {.callout-warning}
In the `download_data.sh` script, the file url should begin either with `https://minio.lab.sspcloud.fr/` or with `s3sspcloud`. It **will not** work if the file path starts with s3.
This is to avoid confusion amoung different S3 settings of your SSPCloud environment. 
:::
