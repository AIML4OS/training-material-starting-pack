...
- The S3 path of your file is simply the path of the folder available in the top right corner of the explorer (red rectangle) and the name of the file (blue rectangle). In the screenshot below, the S3 path of the first file is then: `s3/oliviermeslin/data_SILC_PUF/data_SILC_d2013.parquet`.
- The URL is obtained by replacing `s3/` by `https://minio.lab.sspcloud.fr/`. If the S3 path of the file is `s3/oliviermeslin/data_SILC_PUF/data_SILC_d2013.parquet`, then the file URL will be `https://minio.lab.sspcloud.fr/oliviermeslin/data_SILC_PUF/data_SILC_d2013.parquet`.
