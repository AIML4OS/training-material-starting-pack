...
::: {.callout-warning}
## Python users only: accessing the `Jupyter Notebooks`
...
We assume that the notebook to be recovered is available at <https://aiml4os.github.io/AIML4OS-template-quarto-python/notebooks/notebook1.ipynb> (see above to understand how it was produced).
...
By customizing this script, you should have a ready-to-use environment. To test that the edits you've made to this script work, you can open a terminal on VSCode and run it from the command line. If this test is successful, the script has a good chance of running in a blank environment and creating a customized environment for your training. The aim of the next section is to show you how. Don't forget to commit the modifications you made to that script otherwise, in the next step, trainees won't end up with your notebook ready to use in their environment. 
:::
